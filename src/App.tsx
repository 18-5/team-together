      ...
      <div className='row h-100'>
        <nav className="col-4 d-flex flex-column justify-content-between py-3">
          <Nav variant="pills" className="flex-column">
            ...
            <NavLink to={`search`} className="nav-link disabled fs-5">검색</NavLink>
            <NavLink to={`projects`} className="nav-link fs-5">내 프로젝트</NavLink>
            <NavLink to={`messages`} className="nav-link disabled fs-5">쪽지</NavLink>
            <NavLink to={`notifications`} className="nav-link disabled fs-5">알림</NavLink>
            <NavLink to={`connection-test`} className="nav-link fs-5">Connection Test</NavLink>
            <NavLink to={`projects/1`} className="nav-link fs-5">Sample Project</NavLink>
          </Nav>
